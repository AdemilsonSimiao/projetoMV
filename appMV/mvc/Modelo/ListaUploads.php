...
class ListaUploads extends Modelo {
    const SELECT_UPLOADS = "SELECT * FROM atualizacao WHERE descricao LIKE '%' ? '%' ORDER BY :order LIMIT ? OFFSET ?";
    const CONTAR_TODOS = 'SELECT count(idatualizacao) FROM atualizacao';
    const SELECT_POR_USUARIO = 'SELECT * FROM atualizacao WHERE idusuario = ? ORDER BY descricao LIMIT ? OFFSET ?';
    const CONTAR_TODOS_POR_USUARIO = 'SELECT count(idatualizacao) FROM atualizacao where idusuario = ?';
    const CONTAR_TODOS_POR_USUARIO_PERIODO = 'SELECT count(idatualizacao) FROM atualizacao where idusuario = ? AND atualizacaodados >= ? AND atualizacaodados <= ?';
    const SELECT_POR_USUARIO_PERIODO = 'SELECT * FROM atualizacao WHERE idusuario = ? AND atualizacaodados >= ? AND atualizacaodados <= ? ORDER BY descricao LIMIT ? OFFSET ?' ;
